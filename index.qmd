...
ax1.set_title('All 250 Days: Productivity by Shop and Boss Presence', 
...
ax2.set_title('Productivity Distribution: Boss Present vs Absent', 
              fontsize=14, fontweight='bold', pad=15)
...
ax1.set_title('Annual Revenue: Current vs Recommended Schedule', 
              fontsize=14, fontweight='bold', pad=15)
ax1.set_xticks(x)
...
# Print summary
print(f"\n💰 FINANCIAL SUMMARY (assuming ${revenue_per_car} per car):")
...
2. **Other factors:** We're only tracking your presence. Other things might matter too—weather, day of week, special events, etc.
...
ax1.set_xlabel('Total Cars Fixed per Year', fontweight='bold', fontsize=12)
...
ax2.set_xlabel('Annual Revenue (Thousands $)', fontweight='bold', fontsize=12)
...
1. **Focus on Shops 1, 2, and 4**—your presence makes a real difference there
2. **Let Shops 3 and 5 run independently**—they don't need you for productivity
